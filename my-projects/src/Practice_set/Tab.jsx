    ...
    <div className="min-h-screen bg-slate-50 p-8">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
          <div>
            <h1 className="text-4xl font-black text-slate-900 tracking-tight">Project Hub</h1>
            <p className="text-slate-500 font-medium">Manage and track organization initiatives</p>
          </div>
          
          <div className="flex items-center gap-3">
            <span className="text-xs font-black text-slate-400 uppercase tracking-widest">Sort By:</span>
            <select className="bg-white border border-slate-200 px-4 py-2 rounded-xl text-sm font-bold text-slate-700 outline-none shadow-sm cursor-pointer">
            ...
            >
              <div className="flex items-center gap-6">
                <div className={`w-16 h-16 rounded-2xl flex items-center justify-center text-xl shadow-inner ${
                  project.category === "Enviroment" ? "bg-emerald-100 text-emerald-600" :
                  project.category === "Social" ? "bg-rose-100 text-rose-600" : "bg-blue-100 text-blue-600"
                }`}>
              ...
              <div className="mt-4 md:mt-0 text-right">
                <p className="text-xs font-black text-slate-400 uppercase tracking-widest mb-1">Allocated Budget</p>
        ...
        <div className="mt-10 p-8 bg-indigo-900 rounded-[2.5rem] text-white flex flex-col sm:flex-row justify-around items-center gap-6 shadow-2xl shadow-indigo-200">
          <div className="text-center">
            <p className="text-indigo-300 text-xs font-bold uppercase tracking-widest mb-2">Total Projects</p>
            <p className="text-3xl font-black">{projects.length}</p>
          </div>
          <div className="w-px h-12 bg-indigo-700 hidden sm:block"></div>
          <div className="text-center">
            <p className="text-indigo-300 text-xs font-bold uppercase tracking-widest mb-2">Active Categories</p>
            <p className="text-3xl font-black">3</p>
          </div>
          <div className="w-px h-12 bg-indigo-700 hidden sm:block"></div>
          <div className="text-center">
            <p className="text-indigo-300 text-xs font-bold uppercase tracking-widest mb-2">Combined Budget</p>
